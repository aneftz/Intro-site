...
!function (e, t) {
  ...
  return function () {
    ...
    var o = n && window.THREE || {};
    n && !window.VANTA && (window.VANTA = {});
    var s = n && window.VANTA || {};
    ...
    function () {
      function _class() {
        ...
        if (this.options = Object.assign({
          ...
          el: e
        }), Object.assign(this.options, e), this.options.THREE && (o = this.options.THREE), this.el = this.options.el, null == this.el) r('Instance needs "el" param!');else if (!(this.options.el instanceof HTMLElement)) {
          var _e = this.el;
          if (this.el = (i = _e, document.querySelector(i)), !this.el) return void r("Cannot find element", _e);
        }
        var i, a;
    ...
    var a = s.VantaBase;
    var c = "object" == (typeof window === "undefined" ? "undefined" : _typeof(window)) && window.THREE;
    ...
    function (_a) {
      ...
      function h(e) {
        ...
        c = e.THREE || c, c.Color.prototype.toVector = function () {
          return new c.Vector3(this.r, this.g, this.b);
        }, _this = _possibleConstructorReturn(this, _getPrototypeOf(h).call(this, e)), _this.updateUniforms = _this.updateUniforms.bind(_assertThisInitialized(_this));
        return _this;
      }
      ...
      _createClass(h, [{
        ...
        value: function init() {
          ...
          }, _get(_getPrototypeOf(h.prototype), "init", this).call(this), this.fragmentShader && this.initBasicShader();
        }
      }, {
        key: "setOptions",
        value: function setOptions(e) {
          _get(_getPrototypeOf(h.prototype), "setOptions", this).call(this, e), this.updateUniforms();
        }
      }, {
        key: "initBasicShader",
        value: function initBasicShader() {
          ...
          var o = new c.Mesh(new c.PlaneGeometry(2, 2), i);
        ...
        key: "resize",
        value: function resize() {
          _get(_getPrototypeOf(h.prototype), "resize", this).call(this), this.uniforms.iResolution.value.x = this.width / this.scale, this.uniforms.iResolution.value.y = this.height / this.scale;
        }
      }]);
    ...
    var l = "object" == (typeof window === "undefined" ? "undefined" : _typeof(window)) && window.THREE;
    ...
    function (_h) {
      ...
      function u(e) {
        ...
        l = e.THREE || l, _this2 = _possibleConstructorReturn(this, _getPrototypeOf(u).call(this, e));
        return _this2;
      }
      ...
      _createClass(u, [{
        ...
        key: "initBasicShader",
        value: function initBasicShader(e, t) {
          _get(_getPrototypeOf(u.prototype), "initBasicShader", this).call(this, e, t), this.uniforms.iBuffer = {
            type: "t",
        ...
        value: function onResize() {
          if (this.bufferTarget) {
            var _e3 = this.width * window.devicePixelRatio / this.scale,
                _t3 = this.height * window.devicePixelRatio / this.scale;

            this.bufferTarget.setSize(_e3, _t3), this.bufferFeedback.setSize(_e3, _t3);
          }
        }
      }, {
        key: "onDestroy",
